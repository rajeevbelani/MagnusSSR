  ...
  render () {
    return (
      <Box>
        ...
        <Box pad="large" align="center" textAlign="center">
          <Tabs>
            ...
            <Tab title="Popular Treatments">
              <Tiles>
                  <Card
                  thumbnail="https://cdn.iconscout.com/public/images/icon/premium/png-128/cancer-aids-ribbon-awareness-breast-health-medical-38a22383265617b9-128x128.png"
                  heading="Cancer"
                />
                  <Card
                  thumbnail="https://cdn4.iconfinder.com/data/icons/medical-specialties-set-1/256/Cardiology-128.png"

                  heading="Cardiology"
                />
                  <Card
                  thumbnail="https://cdn4.iconfinder.com/data/icons/orthopedics/92/icon88-17-128.png"
                ...
                />
                  ...
                  colorIndex="light-2"
                >
                  <Anchor href="#" primary label="View All" />
                </Box>}
                />
            ...
            <Tab title="Hospitals">
              <Tiles>
                ...
                <Card thumbnail={<Box
                  ...
                  colorIndex="light-2"
                >
                  <Anchor href="#" primary label="View All (200+)" />
                </Box>}
                />
                {/* <Card thumbnail='/img/apollo.jpg'
                  label='Super Speciality Hospital'
            ...
            <Tab title="Doctors">
              <Tiles>
                <Card
                  thumbnail="/img/drashokseth.jpg"
                  label="Cardiologist"
                  heading="Dr Ashok Seth"
                  description="Sample description providing more details."
                />
                <Card
                  thumbnail="/img/drharit.jpg"
                  label="Oncologist"
                  heading="Dr Harit"
                  description="Sample description providing more details."
                />
                <Card
                  thumbnail="http://www.vaidam.com/sites/default/files/dr._nandita_p._palshetkar.jpg"
                ...
                <Card thumbnail={<Box
                  ...
                  colorIndex="light-2"
                >
                  <Anchor href="#" primary label="View All (300+)" />
                </Box>}
                />
                {/* <Box direction='row'
                    justify='start'
        ...
        <Hero
          size="large"
          backgroundImage="http://antithesisadvertising.com/wp-content/uploads/2015/01/urmcstories-hidden-1-cover.jpg"
          justify="start"
        ...
        >
          <Quote>
            <Card
              ...
              size="large"
              link={
                <Anchor href="#" primary label="Read More" />
              }
            />
          </Quote>
        </Hero>
          ...
          <Box colorIndex="neutral-1" pad="large" align="center" full="horizontal">
            ...
            >
              <Card
                ...
                basis="1/2"
                link={
                  <Anchor href="http://www.grommet.io/docs/" primary>
                    Learn More
                  </Anchor>
                }
                separator="right"
